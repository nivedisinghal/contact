...
<head>
  ...
  <title>Teacher's Panel - Select dates b/w essays</title>
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" style="color:#fff;">Look for Essays
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Search for Specific Essays</h4>
...
<div class="row">
<div class="col-xl-6 col-lg-12">
<button type="submit" name="search" class="btn btn-success btn-min-width mr-1 mb-1">Search</button>
</div>
</div>

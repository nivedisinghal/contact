<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-dark navbar-shadow">
    <div class="navbar-wrapper">
      <div class="navbar-header" style="background-color: #06623b;">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mobile-menu d-md-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="#"><i class="ft-menu font-large-1"></i></a></li>
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="dashboard.php">
        
              <h3 class="brand-text">Teacher's Panel</h3>
            </a>
          </li>
      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile" style="background-color: #fff;">
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="change-password.php"><i class="ft-user"></i> Change Teacher Password</a>
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">
                  <?php 
 $isread=1;                 
$sql = "SELECT id from contact_info where Is_Read!=:isread";
...
<?php 
 $isread=1;      
$sql ="SELECT FullName,PostingDate,id from contact_info where Is_Read!=:isread";
$query = $dbh -> prepare($sql);
$query-> bindParam(':isread', $isread, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6 class="media-heading">New Essays are submitted</h6>
                        <p class="notification-text font-small-3 text-muted">
      <a href="essays.php?cid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->FullName);?></a></p>
                        <small>

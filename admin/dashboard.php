        ...
        <div class="row">
          <div class="col-xl-4 col-lg-6 col-12">
            <div class="card pull-up">
              <div class="card-content" style="background-color:#3f3f44;">
                   <a href="seven-days-essay.php">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
<?php 
$sql = "SELECT id from contact_info where date(PostingDate)=CURDATE()";
...
?>
 <h3 class="info"><?php echo htmlentities($todayscount);?></h3>
                      <h6 style="color:#fff;">Essays Submitted Today</h6>
                    </div>
                    <div>
...
$sql = "SELECT id from contact_info where date(PostingDate)>= DATE(NOW()) - INTERVAL 7 DAY";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$last7dayscount=$query->rowCount() 
 ...
 <h3 class="warning"><?php echo htmlentities($last7dayscount);?></h3>
                      <h6 style="color:#fff;">Essays in the Last 7 days</h6>
                    </div>
                    <div>
    <i class="icon-user-follow success font-large-2 float-right"></i>
                    </div>
...
<h3 class="success"><?php echo htmlentities($allcount);?></h3>
                      <h6 style="color:#fff;">All Submissions</h6>
                    </div>
                    <div>
                      <i class="icon-user-follow success font-large-2 float-right"></i>
                    </div>

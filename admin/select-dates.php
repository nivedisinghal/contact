...
if(isset($_POST['submit'])){
      ...
      $_SESSION['todate']=$todte;
        ...
        echo "<script>window.location.href='essay_bw_dates.php'</script>";
       }
    }
...
<head>
  ...
  <title>Essays Submitted in the Dates</title>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block" style="color:#fff;">
            Essays in between these dates
          </h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" style="color:#fff;">Essays in between these dates
                </li>
              </ol>
            </div>
          </div>
...
<div class="row">
<div class="col-xl-6 col-lg-12">
<button type="submit" name="submit" class="btn btn-success btn-min-width mr-1 mb-1">Submit</button>
</div>
</div>
